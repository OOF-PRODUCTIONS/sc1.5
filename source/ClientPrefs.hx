...
class ClientPrefs {
	...
	public static var windowMove:Bool = true;
	...
	public static var scrollUnderlayAlpha:Float = 0;
	public static var moreScoreInfo:Bool = true;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.scrollUnderlayAlpha = scrollUnderlayAlpha;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.scrollUnderlayAlpha != null) {
			scrollUnderlayAlpha = FlxG.save.data.scrollUnderlayAlpha;
		}
