...
//'Blocked', 'Sweetcorn', 'Revise', 'Cob', 'Idiot', 'Apathetic', 'Screwed', 'Overthink', 'Nomophobia', 'Dismember', 'Kalampokiphobia', 'Reality-Breaking', 'Opposition', 'Cheating', 'Shit', 'Unfairness', 'Phonophobia', 'Hellbreaker'
	...
	public function goToFreeplay()
	{
		...
		for (i in 0...songs.length)
		{
			...
			if(songs[i].songName == 'Hellbreaker' && FlxG.save.data.invisibleWeekUnlocked1 != true) //old one was tutorialCompletePlaceholder2
				{
			...
			else if(songs[i].songName == 'Ornery' && FlxG.save.data.orneryUnlocked1 != true) //old one was tutorialCompletePlaceholder2
			{
			...
			else if(songs[i].songName == 'Spamophobia' && FlxG.save.data.spamophobiaUnlocked1 != true) //old one was tutorialCompletePlaceholder2
			{
				var songText:Alphabet = new Alphabet(0, (70 * i) + 30, 'Hidden Song', true, false);
				songText.isMenuItem = true;
				songText.targetY = i;
		...
		diffText = new FlxSprite(FlxG.width * 0.7, 520);
	...
	override function update(elapsed:Float)
	{
		...
		else*/ #end if (accepted && !playingRN)
		{
			...
			trace(poop);
			if(songLowercase == 'hellbreaker' && FlxG.save.data.invisibleWeekUnlocked1 != true)
				{
					FlxG.sound.play(Paths.sound('cancelMenu'), 0.7);
					if(!unlockTxtThing)
						{
						unlockTxtThing = true;
						youNeedToBeatTxt = new FlxText(0, 0, FlxG.width, "You need to beat Chapter 4 without\neasy mode to unlock.", 32);
			...
			else if(songLowercase == 'ornery' && FlxG.save.data.orneryUnlocked1 != true)
			{
				FlxG.sound.play(Paths.sound('cancelMenu'), 0.7);
				if(!unlockTxtThing)
					{
			...
			else if(songLowercase == 'golden' && FlxG.save.data.goldenUnlocked != true)
				{
					...
					if(!unlockTxtThing)
						{
						unlockTxtThing = true;
						youNeedToBeatTxt = new FlxText(0, 0, FlxG.width, "You need to beat Ornery", 32);
						 youNeedToBeatTxt.setFormat("VCR OSD Mono", 32, FlxColor.WHITE, CENTER, OUTLINE, 0xFF000000);
						  youNeedToBeatTxt.screenCenter(Y);
						 add(youNeedToBeatTxt);
						new FlxTimer().start(1, function(tmr:FlxTimer)
			...
			else if(songLowercase == 'spamophobia' && FlxG.save.data.spamophobiaUnlocked1 != true)
			{
				FlxG.sound.play(Paths.sound('cancelMenu'), 0.7);
				if(!unlockTxtThing)
					{
		...
		{
			if(songs[curSelected].songName == 'Hellbreaker' && FlxG.save.data.invisibleWeekUnlocked1 != true)
				{
	
				}
			else if(songs[curSelected].songName == 'Spamophobia' && FlxG.save.data.spamophobiaUnlocked1 != true)
			{

			}
			else if(songs[curSelected].songName == 'Ornery' && FlxG.save.data.orneryUnlocked1 != true)
			{
